// Footer — Areatec Brand Guidelines Update
// Dark footer with new SVG logo, links, and copyright
import { Mail, Globe } from "lucide-react";

const footerLinks = {
  Soluções: [
    { label: "Fiscalização de Trânsito", href: "#solucoes" },
    { label: "Estacionamento Rotativo", href: "#solucoes" },
    { label: "Zeladoria Urbana", href: "#solucoes" },
    { label: "Segurança Pública", href: "#solucoes" },
  ],
  Tecnologias: [
      ...
      <div className="container">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-5">
              Líder em tecnologia para fiscalização de trânsito, estacionamento rotativo e cidades inteligentes.
            </p>
        ...
        <div className="border-t border-slate-700/50 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            © 2026 Areatec. Todos os direitos reservados.
          </p>
          <div className="flex items-center gap-4">
            <a href="#" className="text-sm text-slate-500 hover:text-slate-300 transition-colors">Política de Privacidade</a>
            <a href="#" className="text-sm text-slate-500 hover:text-slate-300 transition-colors">Termos de Uso</a>
          </div>
        </div>
      </div>
    </footer>
