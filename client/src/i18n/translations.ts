...
const en: Record<string, string> = {
  ...
  "hero.subtitle": "Smart traffic enforcement, digital parking, and video monitoring. Over 200 cities have trusted Areatec for 30 years.",
...
const es: Record<string, string> = {
  ...
  "hero.subtitle": "Fiscalización de tránsito, estacionamiento regulado y videovigilancia. Más de 200 ciudades confían en Areatec desde hace 30 años.",
